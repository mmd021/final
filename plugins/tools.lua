...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@mohamaddige', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if ((matches[1] == 'mmd' and not Clang) or (matches[1] == "mmd" and Clang)) then
